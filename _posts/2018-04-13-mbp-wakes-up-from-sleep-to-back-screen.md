...
{% include figure image_path= "assets/images/blog/Screen-Shot-2018-04-13-at-13.16.22.png" alt="macOS power / shut down menu" caption="macOS power / shut down menu" %}{: .align-center}
...
{% include figure image_path="assets/images/blog/macos-sierra-mbp-progress-bar-after-deep-sleep.png" alt="Waking up from safe sleep" caption="Waking up from safe sleep" %}
